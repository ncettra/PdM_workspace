...
int main(void)
{
  ...
  while (1)
  {
	...
	//Analizo si el boton fue pulsado
	if(BSP_PB_GetState(BUTTON_USER)){
		ordenDeSecuencia++;
	}

	if(ordenDeSecuencia>1){
		ordenDeSecuencia=0;
	}


	//El mismo delay de la secuencia hace de antirebote
	...
	if(i >= (uint8_t)(sizeof(secuencia)/sizeof(secuencia[0]))) { i=0;}
	if(i<0){ i = (uint8_t)((sizeof(secuencia)/sizeof(secuencia[0]))-1);}
